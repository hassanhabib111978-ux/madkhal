...
(function(){"use strict";
  ...
  async function load(){
    ...
    try{
      ...
      const r=await supabaseClient.from("jobs").select("id",{count:"exact",head:true}).eq("status","active").or("expires_at.is.null,expires_at.gt."+now);
